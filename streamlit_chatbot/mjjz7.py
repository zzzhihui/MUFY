...
# Add your accounts here: "Username" : "Password"
USER_ACCOUNTS = {
    "user1": "123456",
    "user2": "654321"
}

# Folder to store each user's data separately
...
def login_page():
    ...
    st.markdown("### Please sign in with your account")
...
# ====================== Time Zone ======================
tz = pytz.timezone("Asia/Kuala_Lumpur")  # Change to Asia/Shanghai for China

# Get current user's personal file path
